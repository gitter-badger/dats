...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_BPM_VALUE = 15,                 /* BPM_VALUE  */
  YYSYMBOL_NL_1 = 16,                      /* NL_1  */
  YYSYMBOL_NL_2 = 17,                      /* NL_2  */
  YYSYMBOL_NL_4 = 18,                      /* NL_4  */
  YYSYMBOL_NL_8 = 19,                      /* NL_8  */
  YYSYMBOL_NL_16 = 20,                     /* NL_16  */
  YYSYMBOL_SEMICOLON = 21,                 /* SEMICOLON  */
  YYSYMBOL_YYACCEPT = 22,                  /* $accept  */
  YYSYMBOL_S = 23,                         /* S  */
  YYSYMBOL_notes = 24,                     /* notes  */
  YYSYMBOL_bpm = 25,                       /* bpm  */
  YYSYMBOL_note_length = 26,               /* note_length  */
  YYSYMBOL_note_key = 27,                  /* note_key  */
  YYSYMBOL_octave = 28                     /* octave  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "BEG", "BPM", "NOTE",
  "END", "C", "D", "E", "F", "G", "A", "B", "VALUE", "BPM_VALUE", "NL_1",
  "NL_2", "NL_4", "NL_8", "NL_16", "SEMICOLON", "$accept", "S", "notes",
  "bpm", "note_length", "note_key", "octave", YY_NULLPTR
};
...
{
      16,    17,    18,    19,    20,    21,    22,     3,     1,     8,
       3,     6,     7,    10,    12,    11,    13,    28,    25,    29,
       9,     0,    15,    27,     0,     0,     0,    24
};

static const yytype_int8 yycheck[] =
{
       7,     8,     9,    10,    11,    12,    13,     4,     3,     6,
       4,     0,    15,     5,     5,    21,    14,    21,    14,    21,
       4,    -1,    12,    24,    -1,    -1,    -1,    15
};
...
{
       0,     3,    23,     4,    24,    25,     0,    15,     6,    25,
       5,    21,     5,    14,    26,    26,     7,     8,     9,    10,
      11,    12,    13,    27,    27,    14,    28,    28,    21,    21
};
